...
function resolveOptions(options) {
  ...
  if (options.decorateRequest) {
    throw new Error(
      'decorateRequest is REMOVED; use decorateProxyReqOpt and decorateReqBody instead.  see README.md'
    );
  }
  ...
  return {
    ...
    decorateProxyReqOpt: options.decorateProxyReqOpt || function(reqOpt /*, req */) { return reqOpt; },
